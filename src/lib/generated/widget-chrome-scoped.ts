...
.buzzy-widget-scope .bz-embed-section {
  margin: 0;
  padding: 0;
...
.buzzy-widget-scope .bz-card:not(.bz-card--surface-flat):not(.bz-card--surface-nested-reply) {
  box-shadow: var(--bz-elev-outline), var(--bz-elev-float);
}

/* Feed list / thread: flat rows (divider) instead of nested boxes */
.buzzy-widget-scope .bz-card.bz-card--surface-flat {
  background: transparent;
  border: none;
  border-radius: 0;
  box-shadow: none;
...
.buzzy-widget-scope .bz-card.bz-card--surface-flat:last-child {
  border-bottom: none;
}

.buzzy-widget-scope .bz-card.bz-card--surface-flat.bz-thread-card {
  padding: 0.9rem 0;
}

/* iOS-style inset grouped list: multiple flat rows in one rounded surface */
.buzzy-widget-scope .bz-entry-list-group {
  background: var(--bz-panel);
  border-radius: var(--bz-card-r);
...
.buzzy-widget-scope .bz-entry-list-group > .bz-card.bz-card--surface-flat {
  padding: 0.82rem 0.9rem;
}

/* Thread replies: secondary “sub-rows” aligned like iOS threaded detail */
.buzzy-widget-scope .bz-card.bz-card--surface-nested-reply {
...
.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply {
  padding: 0.56rem 0.68rem;
}

.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-entry-row {
  gap: 0.62rem;
}

.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-name--sm {
  font-weight: 600;
}

.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-entry-meta {
  font-size: 0.8125rem;
}

/* Nested replies inherit compact typography but show full content (no 3-line clamp). */
.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-body--compact,
.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-body--comfort {
  display: block;
  margin-top: 0.4rem;
...
.buzzy-widget-scope .bz-thread-card.bz-card--surface-nested-reply .bz-actions-row {
  margin-top: 0.62rem;
  padding-top: 0.55rem;
}

@media (hover: hover) and (pointer: fine) {
  .buzzy-widget-scope .bz-thread-card:not(.bz-card--surface-flat):not(.bz-card--surface-nested-reply):hover {
    border-color: color-mix(in srgb, var(--bz-border) 55%, var(--bz-border-soft));
    box-shadow: var(--bz-elev-outline), var(--bz-elev-float-sm);
  }

  .buzzy-widget-scope .bz-card.bz-card--surface-flat:hover {
    background: color-mix(in srgb, var(--bz-input-bg) 48%, transparent);
  }

  .buzzy-widget-scope .bz-entry-list-group .bz-card.bz-card--surface-flat:hover {
    background: color-mix(in srgb, var(--bz-bg) 36%, transparent);
  }

  .buzzy-widget-scope .bz-card.bz-card--surface-nested-reply:hover {
...
.buzzy-widget-scope .bz-av--photo {
  padding: 0;
  overflow: hidden;
  background: var(--bz-tint);
}

.buzzy-widget-scope .bz-av-img {
  width: 100%;
  height: 100%;
  object-fit: cover;
  display: block;
...
.buzzy-widget-scope .bz-list:has(> .bz-card--surface-flat) {
  gap: 0;
}

.buzzy-widget-scope .bz-list:has(> .bz-entry-list-group) {
  gap: 0;
}
...
.buzzy-widget-scope .bz-prose blockquote::before,
.buzzy-widget-scope .bz-tiptap blockquote::before {
  content: "";
  position: absolute;
  left: 0.55rem;
  top: var(--bz-space-2);
...
.buzzy-widget-scope .bz-prose blockquote strong,
.buzzy-widget-scope .bz-tiptap blockquote strong {
  color: color-mix(in srgb, var(--bz-fg) 90%, var(--bz-muted));
  font-weight: 600;
}

.buzzy-widget-scope .bz-prose blockquote code,
.buzzy-widget-scope .bz-tiptap blockquote code {
  font-style: normal;
}

.buzzy-widget-scope .bz-prose blockquote > p,
.buzzy-widget-scope .bz-tiptap blockquote > p {
  margin: 0.28rem 0;
}

.buzzy-widget-scope .bz-prose blockquote > p:first-child,
.buzzy-widget-scope .bz-tiptap blockquote > p:first-child {
  margin-top: 0;
}

.buzzy-widget-scope .bz-prose blockquote > p:last-child,
.buzzy-widget-scope .bz-tiptap blockquote > p:last-child {
  margin-bottom: 0;
}
 ...
 */
.buzzy-widget-scope .bz-modal-body .bz-tiptap blockquote {
  background: color-mix(in srgb, var(--bz-bg) 44%, var(--bz-input-bg));
  color: color-mix(in srgb, var(--bz-fg) 48%, var(--bz-muted));
}

.buzzy-widget-scope .bz-modal-body .bz-tiptap blockquote::before {
...
.buzzy-widget-scope .bz-attachments-thumb-trigger {
  position: relative;
  aspect-ratio: 1 / 1;
  background: var(--bz-tint);
  border-radius: calc(var(--bz-r) * 0.95);
...
.buzzy-widget-scope .bz-attachments-thumb-trigger:focus-visible {
  outline: 2px solid var(--bz-ring);
  outline-offset: 2px;
}

.buzzy-widget-scope .bz-attachments-thumb-trigger:hover:not(:disabled) {
  filter: brightness(0.98);
}

.buzzy-widget-scope .bz-attachments-video-trigger {
  position: relative;
  display: block;
  width: 100%;
  max-height: 12rem;
...
.buzzy-widget-scope .bz-attachments-video-trigger:focus-visible {
  outline: 2px solid var(--bz-ring);
  outline-offset: 2px;
}

.buzzy-widget-scope .bz-attachments-video-poster {
  width: 100%;
  height: 100%;
  max-height: 12rem;
  object-fit: cover;
...
.buzzy-widget-scope .bz-attachments-video-play {
  position: absolute;
  inset: 0;
  display: flex;
  align-items: center;
...
.buzzy-widget-scope .bz-attachments-video-play-ico {
  filter: drop-shadow(0 2px 8px rgba(0, 0, 0, 0.35));
}

.buzzy-widget-scope .bz-attachments-doc-trigger {
  width: 100%;
  margin-bottom: 0.35rem;
...
.buzzy-widget-scope .bz-attachments-doc-trigger:hover:not(:disabled) {
  background: var(--bz-tint);
}

.buzzy-widget-scope .bz-attachments-doc-trigger:focus-visible {
  outline: 2px solid var(--bz-ring);
  outline-offset: 2px;
}
...
.buzzy-widget-scope .bz-media-lightbox-root {
  position: fixed;
  inset: 0;
  z-index: 2147483647;
  display: flex;
...
.buzzy-widget-scope .bz-media-lightbox-root--shown {
  opacity: 1;
}

.buzzy-widget-scope .bz-media-lightbox-backdrop {
  position: absolute;
  inset: 0;
  margin: 0;
  padding: 0;
...
.buzzy-widget-scope .bz-media-lightbox-panel {
  position: relative;
  z-index: 1;
  width: min(100%, 36rem);
...
.buzzy-widget-scope .bz-media-lightbox-root--shown .bz-media-lightbox-panel {
  transform: scale(1) translateY(0);
  box-shadow: var(--bz-elev-outline), var(--bz-elev-float);
}

.buzzy-widget-scope .bz-media-lightbox-close {
  position: absolute;
...
.buzzy-widget-scope .bz-media-lightbox-close:hover:not(:disabled) {
  background: color-mix(in srgb, var(--bz-muted, #64748b) 20%, transparent);
}

.buzzy-widget-scope .bz-media-lightbox-close:focus-visible {
  outline: 2px solid var(--bz-ring);
  outline-offset: 2px;
}

.buzzy-widget-scope .bz-media-lightbox-close-glyph {
  font-size: 0.92rem;
  line-height: 1;
  font-weight: 500;
  opacity: 0.72;
...
.buzzy-widget-scope .bz-media-lightbox-stage {
  flex: 1;
  min-height: 0;
  display: flex;
  flex-direction: column;
...
.buzzy-widget-scope .bz-media-lightbox-img,
.buzzy-widget-scope .bz-media-lightbox-video {
  max-width: 100%;
...
.buzzy-widget-scope .bz-media-lightbox-frame {
  width: 100%;
  flex: 1;
...
.buzzy-widget-scope .bz-media-lightbox-iframe {
  display: block;
  width: 100%;
  height: 100%;
...
.buzzy-widget-scope .bz-media-lightbox-file-fallback {
  text-align: center;
  padding: 1rem 1.25rem 0.75rem;
  max-width: 18rem;
}

.buzzy-widget-scope .bz-media-lightbox-file-hint {
  margin: 0;
  font-size: 0.86rem;
  line-height: 1.35;
  color: var(--bz-muted);
...
.buzzy-widget-scope .bz-media-lightbox-footer {
  flex-shrink: 0;
...
.buzzy-widget-scope .bz-media-lightbox-caption {
  margin: 0;
  flex: 1;
  font-size: 0.8125rem;
  font-weight: 500;
...
.buzzy-widget-scope .bz-media-lightbox-open-link {
  font-size: 0.78rem;
  font-weight: 600;
  color: var(--bz-link);
  text-decoration: none;
...
.buzzy-widget-scope .bz-media-lightbox-open-link:hover {
  text-decoration: underline;
}

.buzzy-widget-scope .bz-media-lightbox-open-link:focus-visible {
  outline: 2px solid var(--bz-ring);
  outline-offset: 3px;
  border-radius: var(--bz-control-r);
}
...
@media (prefers-reduced-motion: reduce) {
  ...
  .buzzy-widget-scope .bz-media-lightbox-root.bz-media-lightbox-root--shown {
    opacity: 1;
  }
}
...
.buzzy-widget-scope .bz-host-identity-summary {
  margin-bottom: 1.1rem;
}

.buzzy-widget-scope .bz-host-identity-row {
  display: flex;
  align-items: center;
  gap: 0.65rem;
  margin-top: 0.38rem;
...
.buzzy-widget-scope .bz-host-identity-avatar {
  width: 2.5rem;
  height: 2.5rem;
  border-radius: var(--bz-control-r);
  object-fit: cover;
...
.buzzy-widget-scope .bz-host-identity-text {
  display: flex;
  flex-direction: column;
  gap: 0.12rem;
  min-width: 0;
...
.buzzy-widget-scope .bz-host-identity-name {
  font-weight: 600;
  font-size: 0.9375rem;
  letter-spacing: -0.015em;
  color: var(--bz-fg);
...
.buzzy-widget-scope .bz-host-identity-email {
  font-size: 0.8125rem;
  color: var(--bz-muted);
  word-break: break-word;
}

.buzzy-widget-scope .bz-host-identity-hint {
  margin: 0.45rem 0 0;
  font-size: 0.75rem;
  line-height: 1.38;
  color: var(--bz-muted);
...
.buzzy-widget-scope .bz-modal-body .bz-modal-intro-icon {
  flex-shrink: 0;
  display: flex;
  align-items: center;
  justify-content: center;
...
.buzzy-widget-scope .bz-modal-body .bz-modal-intro-ico-svg {
  width: 1.1rem;
  height: 1.1rem;
  display: block;
}

.buzzy-widget-scope .bz-modal-body .bz-modal-intro-text {
  margin: 0;
  flex: 1;
  min-width: 0;
  font-size: 0.875rem;
...
.buzzy-widget-scope .bz-modal-body .bz-modal-intro-text strong {
  font-weight: 600;
