...
.buzzy-widget-scope .bz-modal-progress {
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 0.4rem;
...
.buzzy-widget-scope .bz-modal-progress-head {
  width: 100%;
  display: flex;
  justify-content: center;
}

.buzzy-widget-scope .bz-modal-progress-count {
  font-size: 0.75rem;
  font-weight: 500;
  letter-spacing: 0.02em;
  text-transform: none;
...
.buzzy-widget-scope .bz-modal-progress-track {
  display: flex;
  width: 100%;
  max-width: 12rem;
  gap: 0.22rem;
...
.buzzy-widget-scope .bz-modal-progress-seg {
  flex: 1;
  height: 0.14rem;
  border-radius: 999px;
...
.buzzy-widget-scope .bz-modal-progress-seg--done {
  background: color-mix(in srgb, var(--bz-muted) 40%, var(--bz-border-soft));
}

.buzzy-widget-scope .bz-modal-progress-seg--current {
  background: color-mix(in srgb, var(--bz-fg) 35%, var(--bz-muted));
}

.buzzy-widget-scope .bz-modal-step-label {
  margin: 0;
  padding: 0 0.5rem;
  font-size: 0.8125rem;
  font-weight: 500;
